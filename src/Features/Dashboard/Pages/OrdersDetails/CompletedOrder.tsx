...
export default function CompletedOrder() {
    ...
    const data = [
        ...
        { 
            ...
            orderby: 'Ernest Chris',
            accounttype: 'Portal',
            item: 'this will have a long scrollable list of all items purchased this will have a long scrollable list of all items purchased this will have a long scrollable list of all items purchasedthis will have a long scrollable list of all items purchasedthis will have a long scrollable list of all items purchased this will have a long scrollable list of all items purchased this will have a long scrollable list of all items purchased', 
            total: '#40000', 
            purchasedate: '24/24/2024 (3;30pm)', 
            deliveredby: 'Ernest', 
            datadelivered: '24/24/2024 (3;30pm)',  
                ...
                <table className='text-xs overflow-x-auto'>
                    <thead>
                        <tr className='font-Poppins-Semibold' >
                            ...
                            <th className='bg-white'>
                                <p className="w-24">Order ID</p>
                            </th>
                            <th className='bg-white'>
                                <p className="w-24">Order By</p>
                            </th>
                            <th className='bg-white'>
                                <p className="w-24">Account Type</p>
                            </th>
                            <th className='bg-white'>
                                <p className="w-56">Items</p>
                            </th> 
                            <th className='bg-white'>
                                <p className="w-40">Prescription Image</p>
                            </th> 
                            <th className='bg-white'>
                                <p className="w-24">Order Total</p>
                            </th> 
                            <th className='bg-white'>
                                <p className="w-56">Date/Time Purchased</p>
                            </th> 
                            <th className='bg-white'>
                                <p className="w-24">Delivery By</p>
                            </th> 
                            <th className='bg-white'>
                                <p className="w-56">Date/Time Delivered</p>
                            </th>  
                            <th className='bg-white'>
                        ...
                        {data.map((item, index) => {
                            return(
                                <tr key={index} className='font-Poppins-Regular' >
                                    ...
                                    <td><p className='text-xs text-menu_gray  h-24 overflow-scroll' >{item.item}</p></td>
                                    <td><p className='text-xs h-24 overflow-scroll text-center flex items-center text-midlman_color cursor-pointer' >View Image</p></td>
                                    <td>{item.total}</td>
