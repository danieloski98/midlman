    ...
    return (
        <div className='w-full h-full flex flex-col px-10 py-8 ' >  
            ...
            <div className='w-full flex relative flex-row items-center py-8' > 
                ...
                <button onClick={()=> history.push('/dashboard/newbrand')}  className='bg-midlman_color flex flex-row items-center font-Poppins-Bold text-white text-xs py-3 px-6 rounded-md mx-1' >
                                ...
                                <tr key={index} className='font-Poppins-Regular' >
                                    ...
                                    <td> 
                                        <div className=' w-full h-full flex flex-row items-center' >
                                            <div onClick={()=> history.push('/dashboard/editbrand')} className='flex flex-row cursor-pointer' > 
