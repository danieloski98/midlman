...
export default function NewBrand() {
    ...
    return (
        <div className='w-full h-full flex flex-col items-center py-8 ' >  
            ...
            <p className=' w-100 font-Poppins-Semibold text-lg -ml-48' >New Brand</p>   
            <div className='w-full flex flex-col items-center pt-14 pb-8' >
                <div onClick={()=> history.push('/dashboard/brand')}  className='w-100 flex flex-row cursor-pointer ' >
                    ...
                    <p className='font-Poppins-Bold text-menu_gray text-xs ml-2' onClick={goback} >Back to Brands</p>
                </div>
                <div className='w-100 flex flex-col pb-8' > 
                    <div className='w-full pt-8' > 
                        <div className='py-2 mt-4' >
                            <p className='font-Poppins-Semibold text-xs mb-1'>BRAND NAME</p>
                            <Input fontSize='xs' type="tex" name="name" value={formik.values.name} onChange={formik.handleChange} onBlur={formik.handleChange} onFocus={() => formik.setFieldTouched('name', true, true)} />
                    ...
                    <div className='w-full flex flex-row pt-12' >
                        ...
                        <button className='py-3 text-xs font-Poppins-Semibold text-menu_gray bg-entries rounded-md w-full mx-4' onClick={goback} >Cancel</button>
                    </div>
                </div>
            </div>
        </div>
