...
export default function EditExpressAccount() {
    
    const history = useHistory();

    return (
        <div className='w-full h-full flex flex-col items-center py-8 ' >  
            <p className=' w-100 font-Poppins-Semibold text-lg -ml-48' >Edit EXPRESS Account</p>  
            <div className=' w-100 flex flex-row -ml-48 mt-8' >
                <p className='font-Poppins-Regular text-xs text-menu_gray' >Express Account</p>
                ...
                <p className='font-Poppins-Regular text-xs text-menu_gray' >Edit Express Account</p>
                <svg className='mx-2' width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7.71309 6.99999L1.70209 0.98999L0.288086 2.40399L4.88809 7.00399L0.288086 11.597L1.70209 13.011L7.71309 6.99999Z" fill="#828282"/>
                </svg> 
            </div>
