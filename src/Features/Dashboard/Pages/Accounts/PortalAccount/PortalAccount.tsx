    ...
    return (
        <div className='w-full h-full flex flex-col px-10 py-8 ' >  
            ...
            <div className='w-full flex relative flex-row items-center py-8' > 
                ...
                <button onClick={()=> history.push('/dashboard/newportalaccount')}  className='bg-midlman_color flex flex-row items-center font-Poppins-Bold text-white text-xs py-3 px-6 rounded-md mx-1' >
                ...
                <table className='text-xs '>
                    <thead>
                        <tr className='font-Poppins-Semibold' >
                            ...
                            <th className='bg-white'>Business Type</th> 
                            <th className='bg-white'>CAC Document</th> 
                            <th className='bg-white'>Licensce Document</th> 
                                    ...
                                    {index === 0 ?
                                        ...
                                        <td> 
                                            <div className=' w-full h-full flex flex-row items-center' >
                                                <div  onClick={()=> history.push('/dashboard/editportalaccount')} className='flex flex-row cursor-pointer' >
