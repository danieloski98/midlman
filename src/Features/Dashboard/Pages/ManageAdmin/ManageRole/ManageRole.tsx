                        ...
                        {data.map((item, index) => {
                            return(
                                <tr key={index} className='font-Poppins-Regular' >
                                    ...
                                    <td>{item.admin}</td>
                                    <td>{item.date}</td>
                                    <td> <p onClick={()=> history.push('/dashboard/roles')} className='font-Poppins-Medium text-midlman_color cursor-pointer text-center' >{item.admintype}</p> </td>
                                    <td>{item.status}</td>
                                    <td> 
                                        <div className=' w-full h-full flex flex-row items-center' >
                                            <div onClick={()=> history.push('/dashboard/editadmin')}  className='cursor-pointer flex flex-row' >
                        ...
                        <div className="justify-center items-center overflow-x-hidden flex overflow-y-auto inset-0 z-50 fixed outline-none focus:outline-none"> 
                            <div className='w-100 rounded-lg bg-white p-8' >
                                ...
                                <div className='w-full flex justify-center' >
                                    <button onClick={()=> setShowModal(false)} className='py-3 rounded-md mb-4 text-xs px-8 bg-midlman_color text-white font-Poppins-Semibold' >ADD</button>
                                </div>
                            </div>
                        </div>
