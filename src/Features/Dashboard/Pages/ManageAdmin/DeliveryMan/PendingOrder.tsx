...
export default function PendingOrder() { 
    ...
    return (
        <div className='w-full h-full flex flex-col px-10 py-8 ' >  
            <p className='font-Poppins-Semibold text-lg' >Pending Orders by <span className='text-midlman_color ml-1' >Ernest</span></p> 
                                ...
                                <tr key={index} className='font-Poppins-Regular' >
                                    ...
                                    <td> 
                                        <div className=' w-full h-full flex flex-row justify-center items-center' > 
                                            <p onClick={()=> setShowModal(true)} className='font-Poppins-Medium text-xs cursor-pointer text-midlman_color text-center' >View Details</p>
                                        </div>
                                    </td>
                                </tr>
                            )
            ...
            {showModal ? (
                    <>
                        <div className="justify-center flex overflow-x-hidden my-2 overflow-y-auto inset-0 z-50 fixed outline-none focus:outline-none"> 
                            <Invoice close={setShowModal} order='' type='Pending Orders' /> 
                        </div>
