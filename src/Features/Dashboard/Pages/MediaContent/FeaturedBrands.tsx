    ...
    return (
        <div className='w-full h-full flex flex-col items-center' > 
            <div style={{width:'650px'}} className='pt-8 pb-12' >  
                <p className='font-Poppins-Semibold text-lg ' >Featured Brands</p>
                <div className='w-full py-12 px-20' >
                    <p className='font-Poppins-Medium text-sm mt-4'>Featured Brand 1</p>
                    ...
                    <div className=' w-full flex flex-row items-center py-8 justify-end' >
                        ...
                        <p className='ml-1 font-Poppins-Medium text-xs text-midlman_color'>Add Featured Brand</p>
                    </div>
