    ...
    return (
        <div className='w-full h-full flex flex-col items-center' > 
            <div style={{width:'650px'}} className='pt-8 pb-12' >  
                <p className='font-Poppins-Semibold text-lg ' >Social Icons</p>
                <div className='w-full py-8' >
                    <div className='w-full flex flex-row items-center py-4 px-14' >
                        <div className='w-auto' > 
                            <div className='w-36' >
                                <p className='font-Poppins-Medium text-sm' >Social Icon 1</p>
                                <div style={{backgroundColor:'#FAFAFA'}} className='w-full h-40 flex flex-col justify-center items-center border-dashed border-1 border-entries rounded-lg my-2' >
                                    ...
                                    <p className='text-xs text-menu_gray font-Poppins-Regular mt-6' >.png files of 38 x 38px</p> 
                                </div>
                            </div>
                        </div>
                        <div className='w-full mx-6 mt-2' > 
                            <p className='font-Poppins-Medium text-xs mb-2' >NAME OF SOCIAL MEDIA</p>
                            <Input fontSize='xs' />
                            <p className='font-Poppins-Medium text-xs mt-4 mb-2' >URL</p>
                            <Input fontSize='xs' />
                        </div>
                    </div> 
                    <div className='w-full flex flex-row items-center py-4 px-14' >
                    ...
                    <div className='w-full flex flex-row justify-center items-center pt-14' >
