...
export default function EditCoupon() {
    ...
    return (
        <div className='w-full h-full flex flex-col items-center py-8 ' >  
            <p className=' w-100 font-Poppins-Semibold text-lg -ml-48' >Edit Coupon</p>    
                    ...
                    <div className='w-full pt-8' >   
                        <div className='py-2' >
                            ...
                            <div className='flex flex-row items-center'>
                                <Input fontSize='xs'/>
                                <button className=' ml-4 border-1 h-9 border-midlman_color text-midlman_color font-Poppins-Semibold text-xs w-48 px-4 rounded-md' >Re Generate</button>
                            </div>
                        </div>
                        <div className='py-2 mt-4' >
