...
export default function ExpressAccounts() {
    ...
    return (
        <div style={{width:'480px'}}>
            <div className='w-full flex flex-row mb-4 px-4 ' >
                <p className='font-Poppins-Semibold text-lg'>Express Accounts</p>
                <div className='w-full flex flex-1' />
                <p className='font-Poppins-Semibold text-lg text-midlman_color '>(15)</p>
            </div>
