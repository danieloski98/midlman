...
export default function Menu() {
    ...
    return (
        <div className='w-full h-full py-3 text-white' > 
            ...
            <div className='w-full mt-4' > 
                <div onClick={()=> ClickHandler('/dashboard/orderlist', 1)} className={active === 2  ? activeindicator : 'w-full cursor-pointer'} > 
                ...
                <div onClick={()=> ClickHandler('/dashboard/orderlist', 1)} className={dropdown === 'order' ? submenu === 1 ? menuactivecolor: menucolor: 'hidden'}   > 
                    <p className='text-sm font-Poppins-Regular mr-2' >Orders Details</p> 
                </div> 
                <div onClick={()=> ClickHandler('/dashboard/completedorder', 2)} className={dropdown === 'order' ? submenu === 2 ? menuactivecolor: menucolor: 'hidden'}   > 
            ...
            <div className='w-full mt-4' >
                <div onClick={()=> ClickHandler('/dashboard/lowstockproduct', 1)} className={active === 4 ? activeindicator : 'w-full cursor-pointer'} >
                ...
                <div onClick={()=> ClickHandler('/dashboard/lowstockproduct', 1)} className={dropdown === 'report'  ? submenu === 1 ? menuactivecolor: menucolor: 'hidden'} > 
                    <p className='text-sm font-Poppins-Regular mr-2' >Low Stock Products</p> 
                </div>
                <div onClick={()=> ClickHandler('/dashboard/productreview', 2)} className={dropdown === 'report'  ? submenu === 2 ? menuactivecolor: menucolor: 'hidden'} > 
                    <p className='text-sm font-Poppins-Regular mr-2' >Product Views</p> 
                </div>
                <div onClick={()=> ClickHandler('/dashboard/refundrequest', 3)} className={dropdown === 'report'  ? submenu === 3 ? menuactivecolor: menucolor: 'hidden'} > 
                    <p className='text-sm font-Poppins-Regular mr-2' >Refund Requests</p> 
                </div>
                <div onClick={()=> ClickHandler('/dashboard/prescriptionreports', 4)}  className={dropdown === 'report'  ? submenu === 4 ? menuactivecolor: menucolor: 'hidden'}  > 
                    <p className='text-sm font-Poppins-Regular mr-2' >Prescription Reports</p> 
                </div>
            </div>
            <div className='w-full mt-4' >
                <div onClick={()=> ClickHandler('/dashboard/coupon', 1)} className={active === 5  ? activeindicator : 'w-full cursor-pointer'} >
                ...
                <div onClick={()=> ClickHandler('/dashboard/coupon', 1)} className={dropdown === 'coupons'  ? submenu === 1 ? menuactivecolor: menucolor: 'hidden'}  > 
                    <p className='text-sm font-Poppins-Regular mr-2' >Coupon Manager</p> 
                </div>
            </div>
            <div className='w-full mt-4' >
                <div onClick={()=> ClickHandler('/dashboard/shippingmethods', 1)} className={active === 6  ? activeindicator : 'w-full cursor-pointer'} >
                ...
                <div onClick={()=> ClickHandler('/dashboard/shippingmethods', 1)} className={dropdown === 'shipping'  ? submenu === 1 ? menuactivecolor: menucolor: 'hidden'}  > 
                    <p className='text-sm font-Poppins-Regular mr-2' >Shipping Methods</p> 
                </div>
                <div onClick={()=> ClickHandler('/dashboard/flatrate', 2)} className={dropdown === 'shipping'  ? submenu === 2 ? menuactivecolor: menucolor: 'hidden'}  > 
                    <p className='text-sm font-Poppins-Regular mr-2' >Flat Rate</p> 
                </div>
                <div onClick={()=> ClickHandler('/dashboard/shippingmethods', 3)} className={dropdown === 'shipping'  ? submenu === 3 ? menuactivecolor: menucolor: 'hidden'} > 
                    <p className='text-sm font-Poppins-Regular mr-2' >Geolocation</p> 
                </div> 
            </div>
            <div className='w-full mt-4' >
                <div onClick={()=> ClickHandler('/dashboard/manualtopup', 1)} className={active === 7  ? activeindicator : 'w-full cursor-pointer'} >
            ...
            <div className='w-full mt-4' >
                ...
                <div onClick={()=> ClickHandler('/dashboard/landingpage', 1)} className={dropdown === 'web'  ? submenu === 1 ? menuactivecolor: menucolor: 'hidden'} > 
                    <p className='text-sm font-Poppins-Regular mr-2' >Landing Page</p> 
                </div>
                <div onClick={()=> ClickHandler('/dashboard/contactform', 2)} className={dropdown === 'web'  ? submenu === 2 ? menuactivecolor: menucolor: 'hidden'} > 
                    <p className='text-sm font-Poppins-Regular mr-2' >Contact Us Form</p> 
                </div>
                <div onClick={()=> ClickHandler('/dashboard/newsletter', 3)} className={dropdown === 'web'  ? submenu === 3 ? menuactivecolor: menucolor: 'hidden'} > 
                    <p className='text-sm font-Poppins-Regular mr-2' >Newsletter</p> 
                </div> 
                <div onClick={()=> ClickHandler('/dashboard/blog', 4)} className={dropdown === 'web'  ? submenu === 4 ? menuactivecolor: menucolor: 'hidden'}  > 
                    <p className='text-sm font-Poppins-Regular mr-2' >Our Blog</p> 
                </div>
                <div onClick={()=> ClickHandler('/dashboard/aboutus', 5)} className={dropdown === 'web'  ? submenu === 5 ? menuactivecolor: menucolor: 'hidden'} > 
                    <p className='text-sm font-Poppins-Regular mr-2' >About Us</p> 
                </div>
                <div onClick={()=> ClickHandler('/dashboard/faq', 6)} className={dropdown === 'web'  ? submenu === 6 ? menuactivecolor: menucolor: 'hidden'} > 
                    <p className='text-sm font-Poppins-Regular mr-2' >FAQ</p> 
                </div> 
            </div>
            <div className='w-full mt-4' >
                <div onClick={()=> ClickHandler('/dashboard/termsandconditions', 1)} className={active === 9  ? activeindicator : 'w-full cursor-pointer'} >
                ...
                <div onClick={()=> ClickHandler('/dashboard/termsandconditions', 1)} className={dropdown === 'other'  ? submenu === 1 ? menuactivecolor: menucolor: 'hidden'} > 
                    <p className='text-sm font-Poppins-Regular mr-2' >Terms & Conditions</p> 
                </div>
                <div onClick={()=> ClickHandler('/dashboard/privacypolicy', 2)} className={dropdown === 'other'  ? submenu === 2 ? menuactivecolor: menucolor: 'hidden'} > 
                    <p className='text-sm font-Poppins-Regular mr-2' >Privacy Policy</p> 
                </div>
                <div onClick={()=> ClickHandler('/dashboard/refundpolicy', 3)} className={dropdown === 'other'  ? submenu === 3 ? menuactivecolor: menucolor: 'hidden'}> 
                    <p className='text-sm font-Poppins-Regular mr-2' >Refund Policy</p> 
                </div> 
            </div>
            <div className='w-full mt-4' >
                <div onClick={()=> ClickHandler('/dashboard/logos', 1)} className={active === 10  ? activeindicator : 'w-full cursor-pointer'} >
                ...
                <div onClick={()=> ClickHandler('/dashboard/logos', 1)} className={dropdown === 'media'  ? submenu === 1 ? menuactivecolor: menucolor: 'hidden'} > 
                    <p className='text-sm font-Poppins-Regular mr-2' >Logos</p> 
                </div>
                <div onClick={()=> ClickHandler('/dashboard/banners', 2)} className={dropdown === 'media'  ? submenu === 2 ? menuactivecolor: menucolor: 'hidden'} > 
