    ...
    return (
        <div className='w-full h-full flex flex-col px-8 py-8 ' >  
            ...
            <div className='w-full flex relative flex-row items-center py-8' > 
                ...
                <button className='bg-midlman_color flex flex-row items-center font-Poppins-Bold text-white text-xs py-3 px-6 rounded-md mx-1' >
