...
export default function ArticleCard() {
  return (
    <Link href="/article/9009">
      ...
      <div className="xl:w-32/100 lg:w-80 xl:h-auto lg:h-auto xl:border-2 xl:border-gray-100 rounded-lg lg:border-2 lg:rounded-lg xl:p-4 lg:p-6 mb-10 sm:w-full md:w-full sm:h-auto md:h-auto sm:border-2 md:border-2 sm:border-gray-200 md:border-gray-200 sm:p-4 flex flex-col cursor-pointer">
